...
export const TAILWIND_DEFAULT_CLASSES: TailwindFormClasses = {
    ...
    checkInput: 'h-5 w-5 shrink-0 appearance-none rounded-md border border-gray-300 bg-white checked:border-orange-600 checked:bg-orange-600 jsf-check',
    ...
    tabPanel: '',
    arrayRow: 'relative flex items-center gap-3 rounded-lg border border-gray-200 bg-white px-3 py-2.5 shadow-sm transition-colors hover:border-orange-300',
    dragGrip:
