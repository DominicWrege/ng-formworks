...
export const TAILWIND_DEFAULT_CLASSES: TailwindFormClasses = {
    ...
    checkInput: 'h-5 w-5 shrink-0 appearance-none rounded-md border border-gray-300 bg-white checked:border-gray-600 checked:bg-gray-600 jsf-check',
    radioInput: 'h-5 w-5 shrink-0 cursor-pointer appearance-none rounded-full border border-gray-300 bg-white transition-colors checked:border-gray-600 checked:bg-gray-600 checked:bg-[radial-gradient(circle,_white_4px,_transparent_4.5px)]',
    ...
    tabPanel: '',
    arrayRow: 'relative flex items-center gap-3 rounded-lg border border-gray-200 bg-white px-3 py-2.5 shadow-sm transition-colors hover:border-gray-300',
    dragGrip:
