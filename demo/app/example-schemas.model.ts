...
export const Examples: any = {
  'ng-jsf': {
    ...
    schemas: [
      ...
      { name: 'Descriptions',                    file: 'ng-jsf-descriptions', },
      { name: 'Enums',                           file: 'ng-jsf-enums', },
      { name: 'Complex Array',                   file: 'ng-jsf-complex-array', },
      { name: 'App Toolbar Configuration',       file: 'ng-jsf-app-toolbar', },
  ...
  'asf': {
    ...
    schemas: [
      ...
      // Kitchensink / toy examples, hidden to favour real-world forms
  ...
  'rjsf': {
    ...
    schemas: [
      ...
      // Custom UI demo, hidden to favour real-world examples
